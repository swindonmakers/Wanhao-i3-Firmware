...
#if !defined(UI_DISPLAY_CHARSET) || UI_DISPLAY_CHARSET>4
...
#if UI_DISPLAY_CHARSET==4 // Dayinhu remix
#define CHAR_RIGHT '\x10'
#define CHAR_SELECTOR '\x11'
#define CHAR_SELECTED '\x12'
#endif
...
#define UI_TEXT_MUL "Mul"
#define UI_TEXT_BUF "Buf"
#define UI_TEXT_REPRAP ""
...
#if UI_LANGUAGE==1000
#define UI_TEXT_ON               """\xBD"""
#define UI_TEXT_OFF              """\xA7"""
#define UI_TEXT_NA               """\x84""""\x91""""\xF9"""
#define UI_TEXT_YES              """\xD7"""
#define UI_TEXT_NO               """\xA2"""
#define UI_TEXT_SEL              "\003"
#define UI_TEXT_NOSEL            "\004"
#define UI_TEXT_PRINT_POS        """\xFB""""\xF9""""\x93""""\xF4""..."
#define UI_TEXT_PRINTING         """\x93""""\xF4"""
#define UI_TEXT_IDLE             """\xBE""""\xE8"""
#define UI_TEXT_NOSDCARD         """\xE4""SD""\xBC"""
#define UI_TEXT_ERROR            "**** ""\x92""""\xE5"" ****"
#define UI_TEXT_BACK             """\xA0""""\xB0"" \001"
#define UI_TEXT_QUICK_SETTINGS   """\xC0""""\xDB""""\xD3""""\x13"""
#define UI_TEXT_CONFIGURATION    """\xC9""""\x13"""
#define UI_TEXT_POSITION         """\x85""""\xB9""""\x9A""""\xB1""""\xE0""""\x13"""
#define UI_TEXT_EXTRUDER         """\xB2""""\x8C""""\xB1"""
#define UI_TEXT_SD_CARD          "SD""\xBC"""
#define UI_TEXT_DEBUGGING        """\x9B""""\xD8"""
#define UI_TEXT_HOME_ALL         "XYZ""\xA9""""\xC2"""
#define UI_TEXT_HOME_X           "X""\xA9""""\xC2"""
#define UI_TEXT_HOME_Y           "Y""\xA9""""\xC2"""
#define UI_TEXT_HOME_Z           "Z""\xA9""""\xC2"""
#define UI_TEXT_PREHEAT_PLA      """\xF5""""\xCE""PLA"
#define UI_TEXT_PREHEAT_ABS      """\xF5""""\xCE""ABS"
#define UI_TEXT_COOLDOWN         """\xC1""""\xCD"""
#define UI_TEXT_SET_TO_ORIGIN    """\x97""""\xCB""""\xE0""""\x13""""\xD3""""\xDF""""\xF6""""\x99"""
#define UI_TEXT_DISABLE_STEPPER  """\xA7""""\x81""""\x85""""\xB9""""\x9A""""\xB1"""
#define UI_TEXT_X_POSITION       "X""\xE0""""\x13"""
#define UI_TEXT_X_POS_FAST       "X""\xE0""""\x13""(""\xC0"")"
#define UI_TEXT_Y_POSITION       "Y""\xE0""""\x13"""
#define UI_TEXT_Y_POS_FAST       "Y""\xE0""""\x13""(""\xC0"")"
#define UI_TEXT_Z_POSITION       "Z""\xE0""""\x13"""
#define UI_TEXT_Z_POS_FAST       "Z""\xE0""""\x13""(""\xC0"")"
#define UI_TEXT_E_POSITION       """\xB2""""\x8C""""\xB1""""\xE0""""\x13"""
#define UI_TEXT_BED_TEMP         """\xCE""""\x8F""""\xE1""""\x9F"": %Eb\002C"
#define UI_TEXT_EXTR0_TEMP       """\xB2""""\x8C""""\xB1""""\xE1""""\x9F"":  %E0\002C"
#define UI_TEXT_EXTR1_TEMP       """\xB2""""\x8C""""\xB1""2""\xE1""""\x9F"":  %E1\002C"
#define UI_TEXT_EXTR2_TEMP       """\xB2""""\x8C""""\xB1""3""\xE1""""\x9F"":  %E2\002C"
#define UI_TEXT_EXTR0_OFF        """\xB2""""\x8C""""\xB1""""\xA7""""\x81"""
#define UI_TEXT_EXTR1_OFF        """\xB2""""\x8C""""\xB1""2""\xA7""""\x81"""
#define UI_TEXT_EXTR2_OFF        """\xB2""""\x8C""""\xB1""3""\xA7""""\x81"""
#define UI_TEXT_EXTR0_SELECT     "%X0 ""\xB2""""\x8C""""\xB1""1"
#define UI_TEXT_EXTR1_SELECT     "%X1 ""\xB2""""\x8C""""\xB1""2"
#define UI_TEXT_EXTR2_SELECT     "%X1 ""\xB2""""\x8C""""\xB1""3"
#define UI_TEXT_EXTR_ORIGIN      """\x97""""\xCB""""\xE0""""\x13""""\xD3""""\xDF""""\xF6""""\x99"""
#define UI_TEXT_PRINT_X          """\x93""""\xF4""X:%ax"
#define UI_TEXT_PRINT_Y          """\x93""""\xF4""Y:%ay"
#define UI_TEXT_PRINT_Z          """\x93""""\xF4""Z:%az"
#define UI_TEXT_PRINT_Z_DELTA    """\x93""""\xF4"":%az"
#define UI_TEXT_MOVE_X           """\xF2""""\x9D""X:%aX"
#define UI_TEXT_MOVE_Y           """\xF2""""\x9D""Y:%aY"
#define UI_TEXT_MOVE_Z           """\xF2""""\x9D""Z:%aZ"
#define UI_TEXT_MOVE_Z_DELTA     """\xF2""""\x9D"":%aZ"
#define UI_TEXT_JERK             """\x9E""""\x9D""(Jerk):%aj"
#define UI_TEXT_ZJERK            """\x9E""""\x9D""Z(Z-Jerk):%aJ"
#define UI_TEXT_ACCELERATION     """\xB4""""\xDB""""\x9F"""
#define UI_TEXT_STORE_TO_EEPROM  """\x80""""\x91""""\xFF""EEPROM"
#define UI_TEXT_LOAD_EEPROM      """\x90""EEPROM""\xF8""""\xCF"""
#define UI_TEXT_DBG_ECHO         """\xB0""""\xE9""   :%do"
#define UI_TEXT_DBG_INFO         """\xEE""""\xE6""   :%di"
#define UI_TEXT_DBG_ERROR        """\x92""""\xE5""   :%de"
#define UI_TEXT_DBG_DRYRUN       """\xBE""""\xF7""""\xEF"" :%dd"
#define UI_TEXT_OPS_OFF          "%O0 OPS Off"
#define UI_TEXT_OPS_CLASSIC      "%O1 OPS Classic"
#define UI_TEXT_OPS_FAST         "%O2 OPS Fast"
#define UI_TEXT_OPS_RETRACT      "Retract :%Or"
...
#define UI_TEXT_OPS_MOVE_AFTER   "Move after:%Oa"
#define UI_TEXT_ANTI_OOZE        "Anti Ooze"
#define UI_TEXT_PRINT_FILE       """\x93""""\xF4""""\xE2""""\xB7"""
#define UI_TEXT_PAUSE_PRINT      """\xFA""""\xDE""""\x93""""\xF4"""
#define UI_TEXT_CONTINUE_PRINT   """\xB3""""\xF1""""\x93""""\xF4"""
#define UI_TEXT_UNMOUNT_CARD     """\xED""""\xF8""SD""\xBC"""
#define UI_TEXT_MOUNT_CARD       """\xA6""""\xF8""SD""\xBC"""
#define UI_TEXT_DELETE_FILE      """\xD0""""\x8D""""\xE2""""\xB7"""
#define UI_TEXT_FEEDRATE         """\xDB""""\x9F"""
#define UI_TEXT_FEED_MAX_X       """\x14""""\x94""X:%fx"
#define UI_TEXT_FEED_MAX_Y       """\x14""""\x94""Y:%fy"
#define UI_TEXT_FEED_MAX_Z       """\x14""""\x94""Z:%fz"
#define UI_TEXT_FEED_MAX_Z_DELTA """\x14""""\x94"":%fz"
#define UI_TEXT_FEED_HOME_X      """\xA9""""\xC2""X:%fX"
#define UI_TEXT_FEED_HOME_Y      """\xA9""""\xC2""Y:%fY"
#define UI_TEXT_FEED_HOME_Z      """\xA9""""\xC2""Z:%fZ"
#define UI_TEXT_FEED_HOME_Z_DELTA """\xA9""""\xC2"":%fZ"
#define UI_TEXT_ACTION_XPOSITION4 "X:%x0 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sx","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sX",""
#define UI_TEXT_ACTION_YPOSITION4 "Y:%x1 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sy","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sY",""
#define UI_TEXT_ACTION_ZPOSITION4 "Z:%x2 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sz","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sZ",""
#define UI_TEXT_ACTION_XPOSITION_FAST4 "X:%x0 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sx","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sX",""
#define UI_TEXT_ACTION_YPOSITION_FAST4 "Y:%x1 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sy","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sY",""
#define UI_TEXT_ACTION_ZPOSITION_FAST4 "Z:%x2 mm","""\x98""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sz","""\xA3""""\xE0""""\xEA""""\xE0""""\xBD""""\xA7"":%sZ",""
#define UI_TEXT_ACTION_EPOSITION_FAST2 "E:%x3 mm","(1""\xA4"" = 1mm)"
#define UI_TEXT_ACTION_XPOSITION2 "X:%x0 mm","Min:%sx Max:%sX"
#define UI_TEXT_ACTION_YPOSITION2 "Y:%x1 mm","Min:%sy Max:%sY"
#define UI_TEXT_ACTION_ZPOSITION2 "Z:%x2 mm","Min:%sz Max:%sZ"
#define UI_TEXT_ACTION_XPOSITION_FAST2 "X:%x0 mm","Min:%sx Max:%sX"
#define UI_TEXT_ACTION_YPOSITION_FAST2 "Y:%x1 mm","Min:%sy Max:%sY"
#define UI_TEXT_ACTION_ZPOSITION_FAST2 "Z:%x2 mm","Min:%sz Max:%sZ"
#define UI_TEXT_FANSPEED          """\xA1""""\xD1""""\xDB""""\x9F"""
#define UI_TEXT_ACTION_FANSPEED   """\xA1""""\xD1""""\xDB""""\x9F"":%Fs%%%"
#define UI_TEXT_FAN_OFF           """\xA7""""\x81""""\xA1""""\xD1"""
#define UI_TEXT_FAN_25            """\xD3""""\x13""""\xA1""""\xD1""""\xDB""""\x9F""25%%%"
#define UI_TEXT_FAN_50            """\xD3""""\x13""""\xA1""""\xD1""""\xDB""""\x9F""50%%%"
#define UI_TEXT_FAN_75            """\xD3""""\x13""""\xA1""""\xD1""""\xDB""""\x9F""75%%%"
#define UI_TEXT_FAN_FULL          """\xD3""""\x13""""\xA1""""\xD1""""\xCC""""\xDB"""
#define UI_TEXT_STEPPER_INACTIVE  """\x85""""\xB9""""\x9A""""\xB1""""\xB8""""\xC8"""
#define UI_TEXT_STEPPER_INACTIVE2 """\xE4""""\x9D""""\x15""%is""\xC6""""\xFC""""\xAC""""\xA7""""\x81""","(0""\x95""""\x82""""\x89""""\xBD"")"
#define UI_TEXT_POWER_INACTIVE    "3D""\x93""""\xF4""""\xB1""""\xB8""""\xC8"""
#define UI_TEXT_POWER_INACTIVE2   """\xE4""""\x9D""""\x15""%ip""\xC6""""\xFC""""\xAC""""\xA7""""\x81""","(0""\x95""""\x82""""\x89""""\xBD"")"
#define UI_TEXT_GENERAL           """\x89""""\xA8""""\xC9""""\x13"""
#define UI_TEXT_BAUDRATE          """\x83""""\xDC""""\xC4"":%oc"
#define UI_TEXT_EXTR_STEPS        """\x85""""\xB9""""\xDA""/MM:%Se"
#define UI_TEXT_EXTR_START_FEED   """\xCA""""\xD5""""\xDB""""\x9F"":%Xf"
#define UI_TEXT_EXTR_MAX_FEED     """\x14""""\x94""""\xDB""""\x9F"":%XF"
#define UI_TEXT_EXTR_ACCEL        """\xB4""""\xDB""""\x9F"":%XA"
#define UI_TEXT_EXTR_WATCH        """\xE1""""\x9F""""\xE3""""\x9C""""\xD4""""\xB5"":%Xw"
#define UI_TEXT_EXTR_ADVANCE_L    "Advance lin:%Xl"
#define UI_TEXT_EXTR_ADVANCE_K    "Advance quad:%Xa"
#define UI_TEXT_EXTR_MANAGER      """\xE1""""\xBF""""\xC7""""\xD6"":%Xh"
#define UI_TEXT_EXTR_PGAIN        "DT/PID P""\x88""""\xDA"":%Xp"
#define UI_TEXT_EXTR_IGAIN        "PID I""\x88""""\xDA"":%Xi"
#define UI_TEXT_EXTR_DGAIN        "PID D""\x88""""\xDA"":%Xd"
#define UI_TEXT_EXTR_DMIN         """\x14""""\xEC""""\xD9""""\x8C"":%Xm"
#define UI_TEXT_EXTR_DMAX         """\x14""""\x94""""\xD9""""\x8C"":%XM"
#define UI_TEXT_EXTR_PMAX         "PID""\x14""""\x94""""\xFD"":%XD"
#define UI_TEXT_EXTR_XOFF         "X-Offset:%Xx"
#define UI_TEXT_EXTR_YOFF         "Y-Offset:%Xy"
#define UI_TEXT_STRING_HM_BANGBANG """\xB6""""\x96""""\xC7""""\xD6"""
#define UI_TEXT_STRING_HM_PID     "PID""\xC7""""\xD6"""
#define UI_TEXT_STRING_ACTION     """\x9D""""\x15"":%la"
#define UI_TEXT_HEATING_EXTRUDER  """\xB4""""\xCE""""\xB2""""\x8C""""\xB1"""
#define UI_TEXT_HEATING_BED       """\xB4""""\xCE""""\xCE""""\x8F"""
#define UI_TEXT_KILLED            """\xCC""""\x86""""\xA7""""\x81"""
#define UI_TEXT_STEPPER_DISABLED  """\x85""""\xB9""""\x9A""""\xB1""""\xA7""""\x81"""
#define UI_TEXT_EEPROM_STORED     "","""\xC9""""\x13""""\xF3""""\xBA""""\x80""""\x91""""\xFF""EEPROM"
#define UI_TEXT_EEPROM_LOADED     "","""\xC9""""\x13""""\xF3""""\xBA""""\x90""EEPROM""\xF8""""\xCF"""
#define UI_TEXT_UPLOADING         """\xD2""""\x8E""..."
#define UI_TEXT_PAGE_BUFFER       "Buffer:%oB"
#define UI_TEXT_PAGE_EXTRUDER     " E:%ec/%Ec\002C\176%oC"
#define UI_TEXT_PAGE_EXTRUDER1     "E1:%e0/%E0\002C\176%o0"
#define UI_TEXT_PAGE_EXTRUDER2     "E2:%e1/%E1\002C\176%o1"
#define UI_TEXT_PAGE_EXTRUDER3     "E3:%e2/%E2\002C\176%o2"
#define UI_TEXT_PAGE_BED          " B:%eb/%Eb\002C\176%ob"
#define UI_TEXT_SPEED_MULTIPLY    """\xDB""""\x9F""""\xE7""""\xDA"":%om%%%"
#define UI_TEXT_FLOW_MULTIPLY     """\xC3""""\xC4""""\xE7""""\xDA"":%of%%%"
#define UI_TEXT_EXTR_WAIT_RETRACT_TEMP  """\xF5""""\xCE""""\xB0""""\x8B""""\xE1""""\x9F"":%XT\002C"
#define UI_TEXT_EXTR_WAIT_RETRACT_UNITS """\xF5""""\xCE""""\xB0""""\x8B""""\x8A""""\x9F"":%XUmm"
#define UI_TEXT_PRINTER_READY    """\x93""""\xF4""""\xB1""""\xBB""""\xF0"""
#define UI_TEXT_PRINTTIME_DAYS   " ""\xDD"" "
#define UI_TEXT_PRINTTIME_HOURS  ":"
#define UI_TEXT_PRINTTIME_MINUTES ""
#define UI_TEXT_PRINT_TIME     """\x93""""\xF4""""\xD4""""\xB5"""
#define UI_TEXT_PRINT_FILAMENT """\xEB""""\xAB""""\xAB""""\x87"""
#define UI_TEXT_STRING_HM_DEADTIME     """\xBE""""\xF8""""\xD4""""\xB5"""
#define UI_TEXT_STRING_HM_SLOWBANG     """\xC5""""\xDB""""\xB6""""\x96"""
#define UI_TEXT_STOP_PRINT """\xDE""""\xFE""""\x93""""\xF4"""
#define UI_TEXT_MUL """\xDB""""\x9F"""
#define UI_TEXT_BUF """\xAF""""\x91"""
#define UI_TEXT_REPRAP "Prusa i3 3D""\x93""""\xF4""""\xB1"""
#define UI_TEXT_COMPANY """\xA5""""\xB7""""\xAA""""\xAE"" ""\x93""""\xF4""""\xAD"""
#define UI_TEXT_COMPANY_URL "www.dayinhu.com"
